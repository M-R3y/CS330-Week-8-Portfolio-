...
public:
	...
	// adding to the ViewManager.h to declare Scroll_Callback method for use in the ViewManager.cpp
	// mouse scroll wheel callback adjust the speed of the camara 
